...
namespace Randstad.UfoRsm.BabelFish.Tests
{
    class ConsultantTests
    {
        ...
        public async Task Should_Map_Consultant_Debug()
        {
            ...
            export.Payload = Test.Properties.Resources.Debug_Consultant;
            ...
            _entity.Payload = Test.Properties.Resources.Debug_Consultant;
            var sut = new ConsultantTranslation(_producer, _routingBase, _logger);
