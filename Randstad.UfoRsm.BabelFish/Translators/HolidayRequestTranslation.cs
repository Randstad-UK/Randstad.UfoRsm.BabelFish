...
namespace Randstad.UfoRsm.BabelFish.Translators
{
    public class HolidayRequestTranslation : TranslatorBase, ITranslator
    {
        ...
        public async Task Translate(ExportedEntity entity)
        {
            ...
            {
                SendToRsm(JsonConvert.SerializeObject(rsmHolidayRequest), "sws", "holidayclaim", entity.CorrelationId, true, false, entity.EventType);
            ...
            {
                SendToRsm(JsonConvert.SerializeObject(rsmHolidayRequest), Mappers.MapOpCoFromName(holidayRequest.Candidate.OperatingCo.Name).ToString(), "holidayclaim", entity.CorrelationId, true, false, entity.EventType);
