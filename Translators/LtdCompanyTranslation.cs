...
namespace Randstad.UfoSti.BabelFish.Translators
{
    public class LtdCompanyTranslation : TranslatorBase, ITranslator
    {
        ...
        public async Task Translate(ExportedEntity entity)
        {
            ...
            {
                _logger.Warn($"Problem deserialising Ltd Company from UFO {exp.Message}", entity.CorrelationId, entity, entity.ObjectId, "Dtos.Ufo.ExportedEntity", null);
                entity.ExportSuccess = false;
                return;
            }

            _logger.Success($"Recieved Ltd Company {ltd.Name}", entity.CorrelationId, ltd, entity.ObjectId, "Dtos.Ufo.LtdCompany", null);
